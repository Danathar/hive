...
// These tests pin the FAILURE path of Server.persistSessionsLocked; the two
// collector persist helpers are covered in pkg/dashboard/collect. Their happy paths were already covered by the
