...
- [ADR-0011: Knowledge system for durable agent context](0011-knowledge-system.md)
...
- [ADR-0019: Forge-neutral actionable enumeration with GitHub parity](0019-forge-neutral-enumeration.md)
