...
| Work | Outcome | Tracking |
| --- | --- | --- |
| Token-metering sourcing | **Proposed — awaiting maintainer sign-off on #6234/#6242.** Adopt a hybrid sourcing model: a pinned `ccusage --json --offline` subprocess parses the covered CLI backends, while Hive keeps attribution, budget windows, price labels (`native` vs `estimated`), and the Bob scanner until ccusage covers it. | [#6242](https://github.com/hivecommons/hive/issues/6242), [#6234](https://github.com/hivecommons/hive/issues/6234), [token tracking](token-tracking.md#sourcing-decision-hybrid-ccusage-parsing-with-hive-attribution), [ccusage design path](https://github.com/hivecommons/hive/blob/v4/src/docs/design/token-metering-ccusage.md) |
| v5 GA readiness bar | A v5 stable release is declared only when every row of the GA bar has an owner, a reproducible measurement source, and passing evidence. The v4 EOL announcement is blocked on this checklist being complete — no EOL date before the tracker closes. The bar doc lives on the `v5` branch ([v5-ga.md](https://github.com/hivecommons/hive/blob/v5/src/docs/v5-ga.md)); this row keeps the dependency visible on the published (v4) roadmap. | live tracker: [#6016](https://github.com/hivecommons/hive/issues/6016); open row trackers: [#6112](https://github.com/hivecommons/hive/issues/6112), [#6113](https://github.com/hivecommons/hive/issues/6113), [#6125](https://github.com/hivecommons/hive/issues/6125), [#6130](https://github.com/hivecommons/hive/issues/6130) |
| Per-repo policy scoping | **Proposed — awaiting maintainer sign-off on #6208.** Name repo-scoped policy as one theme instead of separate shapes for pause, agents, and ACMM: align on `project.paused_repos` as the shipped v5 pause precedent, extend toward `project.repos[].policy` (or an equivalent `repo_policy:` map) for repo-scoped keys, make hive-wide ACMM the ceiling and repo overrides narrower than hive-wide defaults, then sequence pause → per-repo agents → ACMM levels/onboarding. | [#6208](https://github.com/hivecommons/hive/issues/6208), [#6111](https://github.com/hivecommons/hive/issues/6111), [#6203](https://github.com/hivecommons/hive/issues/6203), [#6204](https://github.com/hivecommons/hive/issues/6204), [#6211](https://github.com/hivecommons/hive/issues/6211), [#6215](https://github.com/hivecommons/hive/issues/6215), [#6235](https://github.com/hivecommons/hive/issues/6235), [#6263](https://github.com/hivecommons/hive/issues/6263), [#6264](https://github.com/hivecommons/hive/issues/6264) |
